...
snap_order=1         ! 1 - linear , 2 quadratic ; 11 - n-linear

! -- DIFFERENT NUMERICAL WAYS TO PERFORM THE FIT ---

snap_fit_type=3      ! 0  - home made BH ;
...
n_rbf=8            ! The number of radial channels
n_cheb=6            ! The number of Chebyshev polynomials
